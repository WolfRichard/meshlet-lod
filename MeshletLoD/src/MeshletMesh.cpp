...
// (should check if there is a solution without a map is possible by just using a vector to store the bones and use their index position as boneID (just a vector of their matrices))
