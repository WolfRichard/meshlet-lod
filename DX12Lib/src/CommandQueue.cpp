...
Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList7> CommandQueue::CreateCommandList(Microsoft::WRL::ComPtr<ID3D12CommandAllocator> allocator)
{
...
Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList7> CommandQueue::GetCommandList()
{
    Microsoft::WRL::ComPtr<ID3D12CommandAllocator> commandAllocator;
    Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList7> commandList;
...
uint64_t CommandQueue::ExecuteCommandList(Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList7> commandList)
{
    commandList->Close();
